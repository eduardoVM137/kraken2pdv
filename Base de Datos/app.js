...
import etiqueta_productoRoutes from './Routes/etiqueta_productoRoutes.js';
...
import detalle_ingresoRoutes from './Routes/detalle_ingresoRoutes.js';
...
app.use('/api/detalleingreso', detalleIngresoRoutes);
app.use('/api/detallestate', detalleStateRoutes);
...
app.use('/api/detalle-ingreso', detalle_ingresoRoutes);
