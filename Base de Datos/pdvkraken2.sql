...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-04-2024 a las 08:32:29
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `speditar_detalle_ingreso` (IN `iddetalle_ingreso` INT, IN `idingreso` INT, IN `idproducto` INT, IN `cantidad` DECIMAL(18,2), IN `precio_costo` DECIMAL(18,2))   BEGIN
...
--
ALTER TABLE `detalle_state`
  MODIFY `iddetalle_state` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
